...
*   Students will take part in group discussions and problem-solving activities while promoting an environment of collegiality.
...
*   Each flipped class period will have the following structure:
     -  10 - 15 minutes in which students working in their groups will attempt to gain clarification on the questions they identified from the book and video lectures. This period may also be used to consult the instructor as well.
     -  ~30 minutes in which groups working together will explore the given topic through exercises: Including thought exercises involving pen and paper as well as coding exercises. This is a group effort and students are encouraged to ask questions amongst themselves as well as from the Instructor. The goal here is to help each other understand the material, while gaining clarification from the Instructor, through the sharing of knowledge as well as the active experience of solving problems.
...
*   Participation in the in-class activities is encouraged, if a student is actively not participating (during a Participation Event day), it will be noted as non-participation. That being said, each student should fulfill the minimum requirements preceding a class day, these activities include, but are not limited to, the following:
    -   Reading the assigned material
    -   Watching the attached video lecture
    -   Completing any out-of-class exercises
*   I fully expect that every student will meet the participation goals, but as extra encouragement, there will be ten random Participation Events. Each event is worth an Extra Credit of 1% on top of your overall grade in the course.
